...
## Tech Stack
mollypi/k8s-config-connector is built on the following main stack:
...
# Tech Stack File
![](https://img.stackshare.io/repo.svg "repo") [mollypi/k8s-config-connector](https://github.com/mollypi/k8s-config-connector)![](https://img.stackshare.io/public_badge.svg "public")
<br/><br/>
